...
const Pricing: React.FC = () => {
	...
	const handleBuy = async () => {
		const data = await ApiGateway.PaymentUrl(Utils.generateRandomCode(), Utils.convertUsdToVnd(3), "Buy membership")
				...
				<div className="content-container">
					<div className="membership-container">
						...
						<div className="membership">
							...
							<button className="join" onClick={handleBuy}>Join Pro</button>
						</div>
					</div>
