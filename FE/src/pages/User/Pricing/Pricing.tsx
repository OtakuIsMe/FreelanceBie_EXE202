...
const Pricing: React.FC = () => {
	...
	const fetchCheckMembership = async () => {
		...
		setIsBuy(data.status)
	}



	const handleBuy = async () => {
		const data = await ApiGateway.PaymentUrl(Utils.generateRandomCode(), Utils.convertUsdToVnd(3), "Buy membership", "membership")
				...
				<div className="content-container">
					<div className="membership-container">
						...
						<div className="membership">
							...
							<button className="join" onClick={handleBuy} disabled={isBuy}>
								{isBuy ? "Already Bought" : "Join Pro"}
							</button>
						</div>
					</div>
